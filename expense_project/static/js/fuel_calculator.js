    ...
    if (typeof(Storage) !== "undefined") 
        {
            ...
            sessionStorage.setItem("Prel", document.getElementById('Prel').value);
            sessionStorage.setItem("fueldate", document.getElementById('fueldate').value);
            sessionStorage.setItem("origin_array", origin_array);
            sessionStorage.setItem("destination_array", destination_array);
            // update();
            sessionStorage.setItem("distances", distances);

            var rname = document.getElementById("Pname").value; // rider name
            var shift = document.getElementById("Prel").value; // shift
            var fueldate = document.getElementById("fueldate").value;
            var TAP = sessionStorage.getItem('TAP');
            var distance= sessionStorage.getItem('Total_distance');
            var incentive= sessionStorage.getItem('incent');
            var calfuel= sessionStorage.getItem('calfuel');
            ...
            fetch("/fuel-calculator/calculate-fuel/", {
